...
public class Estudiantes2 {
    ...
    private static void mayores18(Connection conexion) throws SQLException {
        // Crea una declaración SQL para ejecutar una consulta de selección.
        Statement statement = conexion.createStatement();

        // Define la consulta SQL para obtener todos los estudiantes mayores a 18.
        String consultaSQL = "SELECT * FROM estudiantes WHERE TIMESTAMPDIFF(YEAR, fecha_nacimiento, CURDATE()) > 18";
